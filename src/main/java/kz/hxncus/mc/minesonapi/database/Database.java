...
public abstract class Database implements IDatabase {
    ...
    protected Database(@NonNull Plugin plugin, @NonNull String url, @NonNull String username, @NonNull String password, @Nullable Map<String, String> properties, @Nullable String tableSQL) {
        this.plugin = plugin;
        this.url = url;
