...
public class SimpleWorld {
	 ...
	 */
	public SimpleWorld setWorldPlayersGameMode(final GameMode gameMode) {
		for (final Player player : this.getWorldPlayers()) {
	 ...
	 * @return the simple world
	 */
	public SimpleWorld setWorldBorderCenter(final double x, final double z) {
	 ...
	 * @return the simple world
	 */
	public SimpleWorld setWorldBorderSize(final double size) {
	 ...
	 * @return the simple world
	 */
	public SimpleWorld setDeathMessageVisibility(final boolean visible) {
		for (final Player player : this.getWorldPlayers()) {
	 ...
	 */
	public String getGameRule(final GameRule<?> rule) {
	 ...
	 * @return the spawn location
	 */
	public SimpleWorld setSpawnLocation(final int x, final int y, final int z, final float angle) {
	 ...
	 */
	@NonNull
	public SimpleWorld setBiome(final Location location, final Biome biome) {
