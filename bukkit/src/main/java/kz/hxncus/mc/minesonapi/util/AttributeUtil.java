...
public class AttributeUtil {
    ...
    public void acceptIfExists(AttributeInstance instance, Consumer<AttributeInstance> consumer) {
        if (instance != null) {
            consumer.accept(instance);
        }
    }

    public Set<AttributeInstance> getAttributeInstances(Attributable attributable) {
        Set<AttributeInstance> attributeInstances = new HashSet<>();
