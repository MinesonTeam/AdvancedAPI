...
public class SimpleInventory {
    ...
    private void registerInventory() {
        ...
        Schedule.later(1L, this::onInitialize);
    }
    ...
    @NonNull
    public SimpleInventory addItem(ItemStack item, Consumer<InventoryClickEvent> handler) {
    ...
    @NonNull
    public SimpleInventory setItem(int slot, ItemStack item, Consumer<InventoryClickEvent> handler) {
    ...
    @NonNull
    public SimpleInventory setItems(int slotFrom, int slotTo, ItemStack item, Consumer<InventoryClickEvent> handler) {
    ...
    @NonNull
    public SimpleInventory setItems(ItemStack item, Consumer<InventoryClickEvent> handler, int @NonNull ... slots) {
        for (int slot : slots) {
            setItem(slot, item, handler);
        }
        return this;
    ...
    @NonNull
    public SimpleInventory addOpenHandler(Consumer<InventoryOpenEvent> openHandler) {
        this.openHandlers.add(openHandler);
        return this;
    }

    @NonNull
    public SimpleInventory addCloseHandler(Consumer<InventoryCloseEvent> closeHandler) {
        this.closeHandlers.add(closeHandler);
        return this;
    }

    @NonNull
    public SimpleInventory addClickHandler(Consumer<InventoryClickEvent> clickHandler) {
