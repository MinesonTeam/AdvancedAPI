...
public class AdvancedValueGenerator<T> {
	 ...
	 */
	public AdvancedValueGenerator<T> add(@NonNull final T key, final double chance) {
	 ...
	 * @return the key generator
	 */
	public AdvancedValueGenerator<T> add(@NonNull final T key, final double chance, final double range) {
		if (chance > range) {
	 ...
	 * @return the key generator
	 */
	public AdvancedValueGenerator<T> addAll(final @NonNull Map<? extends T, ? extends Map.Entry<Double, Double>> map) {
	 ...
	 * @return the key generator
	 */
	public AdvancedValueGenerator<T> remove(@NonNull final T key) {
