...
public class AdvancedRandom extends Random {
	 ...
	 * @param s1 the s 1
	 */
	protected AdvancedRandom(final long s0, final long s1) {
		this.s0 = s0;
		this.s1 = s1;
	}
	 ...
	 * @param seed the seed
	 */
	protected AdvancedRandom(final long seed) {
		this.setSeed(seed);
	}
	 ...
	 */
	public AdvancedRandom copy() {
		return new AdvancedRandom(this.s0, this.s1);
	}
	 ...
	 * @return the simple random
	 */
	public AdvancedRandom jump() {
		return this.jump(JUMP);
	}
	
	private AdvancedRandom jump(final long[] jump) {
		long s0 = 0L;
		long s1 = 0L;
	 ...
	 * @return the simple random
	 */
	public AdvancedRandom longJump() {
	 ...
	 * @return the simple random
	 */
	public static AdvancedRandom get() {
		...
		final AdvancedRandom result = instance;
		if (result != null) {
			return result;
		}
		synchronized (AdvancedRandom.class) {
			if (instance == null) {
				instance = new AdvancedRandom();
			}
			return instance;
		}
	}
