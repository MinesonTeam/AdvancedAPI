...
public class PlayerLeftClickEvent extends PlayerEvent implements Cancellable {
	...
	public PlayerLeftClickEvent(@NonNull final Player who, @NonNull final Action action, final ItemStack item, final Block clickedBlock, @NonNull final BlockFace clickedFace) {
        this(who, action, item, clickedBlock, clickedFace, EquipmentSlot.HAND);
    }

    public PlayerLeftClickEvent(@NonNull final Player who, @NonNull final Action action, final ItemStack item, final Block clickedBlock, @NonNull final BlockFace clickedFace, final EquipmentSlot hand) {
        this(who, action, item, clickedBlock, clickedFace, hand, null);
    }

	public PlayerLeftClickEvent(final Player who, final Action action, final ItemStack item, final Block clickedBlock, final BlockFace clickedFace, final EquipmentSlot hand, final Vector clickedPosition) {
		super(who);
		this.action = action;
		this.item = item;
