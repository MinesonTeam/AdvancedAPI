...
public class Chunk_1_21_R1 implements NMSChunk {
	...
	public void setBlockInNativeChunk(final World world, final int x, final int y, final int z, final int blockId, final boolean applyPhysics) {
		...
		this.nmsWorld.notifyAndUpdatePhysics(blockPos, this.nmsChunk, existing, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), 3, 512);
	}
}
